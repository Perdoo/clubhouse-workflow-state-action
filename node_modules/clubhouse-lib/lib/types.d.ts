...
export declare type CreateLabelParams = {
    color?: string;
    description?: string;
    external_id?: string;
    name: string;
...
export declare type LinkedFileChange = {
    name?: string;
    description?: string;
    content_type?: string;
    size?: number;
...
export declare type CreateTaskParams = {
    complete?: boolean;
    created_at?: string;
    description: string;
    external_id?: string;
...
export declare type UpdateTaskParams = Partial<CreateTaskParams>;
...
export declare type CreateExternalTicketParams = {
    external_id: string;
    external_url: string;
};
export declare type ExternalTicket = {
...
export declare type CreateStoryCommentParams = {
    author_id?: ID;
    created_at?: string;
    external_id?: string;
    text: string;
...
export declare type StoryChange = {
    after_id?: ID;
    archived?: boolean;
    before_id?: ID;
    branch_ids?: Array<ID>;
...
export declare type EpicChange = {
    name?: string;
    owner_ids?: Array<ID>;
    state?: EpicStates;
    created_at?: string | null;
...
export declare type WorkflowStateTypes = 'unstarted' | 'started' | 'done';
...
export declare type StoryLinkChange = {
    object_id: ID;
    subject_id: ID;
    verb: StoryLinkVerb;
};
