...
export type UpdateLabelParams = $Rest<CreateLabelParams, { ... }>;
...
export type UpdateTaskParams = $Rest<CreateTaskParams, { ... }>;
export type Task = {
  complete: boolean,
...
export type Branch = {
  ...
  name: string,
  persistent: boolean,
  pull_requests: Array<{ [key: string]: any, ... }>,
...
export type Commit = {
  author_email: string,
  author_id: ID | null,
  author_identity: { [key: string]: any, ... },
  created_at: string,
  entity_type: string,
  hash: string,
  id: number | null,
...
export type Epic = {
  ...
  external_id: string | null,
  external_tickets: Array<{ [key: string]: any, ... }>,
  follower_ids: Array<ID>,
